  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-2xl px-6 md:px-12 text-white">
        ...
        <p className="text-white mb-10 text-xl leading-relaxed max-w-lg drop-shadow-lg">
          Discover detailed insights about player rankings, events, and strategy. 
          Perfect analysis in less than 2 seconds.
        </p>

        <div className="flex gap-4 flex-wrap">
          <button 
            onClick={onAnalyzeClick}
            className="bg-teal-500 text-white font-bold px-10 py-4 rounded-2xl hover:scale-105 hover:bg-teal-400 transition-all duration-300 shadow-2xl">
            Upload Screenshot
          </button>
          <button className="border-2 border-white/70 backdrop-blur-md bg-white/15 px-10 py-4 rounded-2xl hover:bg-white hover:text-teal-900 transition-all duration-300 font-bold shadow-xl">
            Watch Demo
          </button>
        </div>
